...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>Add Owner <small>Owner</small></h2>
              ...
              <div class="x_content">
                ...
                @include('layouts.errors-and-messages')
                 <form action="{{ route('admin.users.store') }}" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                   {{ csrf_field() }}
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input id="middleName" class="form-control col-md-7 col-xs-12"name="middleName" placeholder="Middle Name" type="text">
                    </div>
                  </div>
                  <div class="item form-group">
